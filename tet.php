    ...
    <table class="table">
      ...
      <tbody>
        <?php
                ...
                $sql = "SELECT *, @row_number:=@row_number+1 AS row_number FROM userinformation, (SELECT @row_number:=0) AS t";
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class='btn btn-danger btm-sm' href='/student/delete.php?ID={$row['ID']}' onclick='return confirm(\"Are you sure?\");'>Delete</a>
                            </td>
                        </tr>
                        ";
                    }
